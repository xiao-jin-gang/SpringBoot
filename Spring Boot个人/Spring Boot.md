...
![idea设置](C:/Users/11628/Desktop/Spring Boot 笔记+课件/images/搜狗截图20180129151045.png)



![images/](C:/Users/11628/Desktop/Spring Boot 笔记+课件/images/搜狗截图20180129151112.png)
...
![自动配置类](C:\Users\11628\Desktop\Spring Boot 笔记+课件\images\搜狗截图20180129224104.png)
 ...
 *      prefix = "person"：配置文件中哪个下面的所有属性进行一一映射 person是配置文件里的
 *
...
![idea配置乱码](file://C:/Users/11628/Desktop/Spring%20Boot%20%E7%AC%94%E8%AE%B0+%E8%AF%BE%E4%BB%B6/images/%E6%90%9C%E7%8B%97%E6%88%AA%E5%9B%BE20180130161620.png?lastModify=1606439948)
...
图示；![concrete-bindings](C:\Users\11628\Desktop\Spring Boot个人\images\concrete-bindings.png)
...
统一日志记录，即使是别的框架和我一起统一使用slf4j进行输出？![legacy](C:\Users\11628\Desktop\Spring Boot个人\images\legacy.png)
...
底层依赖关系![搜狗截图20180131220946](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180131220946.png)
...
![搜狗截图20180131221411](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180131221411.png)
...
![搜狗截图20180203181751](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180203181751.png)
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\template-engine.png)
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\2018-02-04_123955.png)
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180211130721.png)
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180211134506.png)
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180301142915.png)
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180303145450.png)

![](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180303145531.png)
...
yum remove docker \
  ...
  yum-config-manager \
    ...
    #更新yum软件包索引
    yum makecache fast
    #4.安装docker相关的内容 客户端 容器 核心  docker-ce社区版 ee企业版
    ...
    #7hello -world   出现Hello from Docker！说明Docker安装成功
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\阿里云镜像加速.jpg)
...
{
  "registry-mirrors": ["https://k2w2m4dw.mirror.aliyuncs.com"]
}
EOF
#服务重启
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\helloworld.jpg)

![](C:\Users\11628\Desktop\Spring Boot个人\images\docker_run分析.jpg)
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\docker原理.jpg)
...
所以说，新建一个容器的时候，docker不需要像虚拟机一样加载一个操作系统的内核，避免引导。虚拟机是加载Guest OS,分钟级别的，而Docker是利用宿主机的操作系统，省略了这个复杂的过程，秒级！
...
#CentOS7不能关闭防火墙  这里用systemctl stop firewalld
11、查看容器的日志
...
![](C:\Users\11628\Desktop\Spring Boot个人\images\搜狗截图20180305194443.png)
...
```java
使用MapperScan批量扫描所有的Mapper接口；就不用在一个个接口上添加mapper了
...
1)、编写一个实体类（bean）和数据表映射，并且配置好映射关系

```java
//使用JPA注解配置映射关系
@Entity //告诉JPA这是一个实体类（和数据表映射的类）
@Table(name = "tbl_user") //@TABLE来指定和哪个数据表对应，如果省略表明就是user
public class User {
    @Id //这是个主键
...
Application=>CachingProvider(缓存提供者)=>CacheManager(缓存管理器)=>Cache(缓存)=>Entry<K,V>
...
## 1.springboot中图片存储及访问路径问题

```java
将URL的访问路径映射到物理路径中去
这是个配置类，重写WebMvcConfigurer中的方法
@Configuration
public class UploadMapping implements WebMvcConfigurer {
    //对于上传文件的存储路径，需要定义类进行单独配置
    @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        //注册，所有请求到upfile下的所有资源 我们映射到磁盘上的位置上
        //设置请求路径和物理路径的映射关系
        registry.addResourceHandler("/upfile/**").addResourceLocations("file:E:/images  ---》存储在本地文件路径");        
    }
}
```
